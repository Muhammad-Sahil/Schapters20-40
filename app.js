...
// Perform case insensitive search. Whether the user enters cookie, Cookie, 
// COOKIE or coOkIE, program should inform about its availability
// Answer:
...
// 15. Write a program to take password as an input from user. The password must 
// qualify these requirements: a. It should contain alphabets and numbers b. It 
// should not start with a number c. It must at least 6 characters long If the 
// password does not meet above requirements, prompt the user to enter a valid 
// password. For character codes of a-z, A-Z & 0-9, refer to ASCII table at the end 
// of this document.
// Answer:

// function CheckPassword(inputtxt) 
// { 
// var passw=  /^[A-Za-z]\w{0,6}$/;
// if(inputtxt.value.match(passw)) 
// { 
// alert('Correct, try another...')
// return true;
...
// 16. Write a program to convert the following string to an array using string split
...
// var pak = "Pakistan";
// var lastCharOfpak=hello.slice(-1)
// console.log(lastCharOfpak)

// 18. You have a string “The quick brown fox jumps over the lazy dog”. Write a 
// program to count number of occurrences of word “the” in given string.
// Answer:
